...
image_editable.text((70,98), formatTime(secondTime[15:len(secondTime)].upper()), (0, 0, 0), font=ImageFont.truetype('resources/Roboto-Bold.ttf', 43))
...
background.save("finalImage.jpg")
